...
<footer class="flex-rw">
  ...
  <ul class="footer-list-top" style="padding-left: 130px;">
    <li>
      <h4 class="footer-list-header">RÓE</h4>
    </li>
    ...
    <li><a class="generic-anchor footer-list-anchor" style="font-size:15px ;"><i class="fa-solid fa-envelope"></i> róe1910067@gmail.com</a></li>
    <li><a class="generic-anchor footer-list-anchor" style="font-size:15px ;"><i class="fa-solid fa-globe"></i> www.róe.com</a></li>
  </ul>
  <ul class="footer-list-top" style="padding-left: 130px;">
    <li>
